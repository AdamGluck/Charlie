...
#define ATTSKVersionString  @"2.0.0"
#define ATTSKBuildString    @"2A009"
...
/** Assigned to ATTSpeechService.audioFormat to specify AMR narrowband format, 
 which has a bitrate of 12.2k bps. **/
extern NSString* const ATTSKAudioFormatAMR_NB;
/** Assigned to ATTSpeechService.audioFormat to specify uncompressed streaming 
 WAV narrowband format, which has a bitrate of 128 kbps. **/
extern NSString* const ATTSKAudioFormatWAV_NB;
/** Assigned to ATTSpeechService.audioFormat to specify uncompressed streaming 
 WAV wideband format, which has a bitrate of 256 kbps. **/
